...
void chassis_power_control(void)
{
    ...
    float chassis_max_power = 80.0f; // 默认值，后文由裁判系统覆盖
    ...
    if (P_total > chassis_max_power) 
    {
        ...
        if (power_scale > 1.0f) power_scale = 1.0f;
